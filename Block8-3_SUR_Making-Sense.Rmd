...
This next part is beyond the scope of this lesson, but if you really want to get crazy, you can adjust any part of the plot you'd like. 

:::question

Copy + paste this code in your RStudio editor and run it to see the results.
...
In addition to these files, you can imagine that you might want to save other snapshots of the data (ie. `light_users`, `heavy_users`, etc.), or the plot you created.
