...
You will have hopefully already set up an account on OSF. If not, follow the instructions on this page: <a href="Block7_EXT-osfSetup.html">OSF Setup</a>

For this workshop, we have set up a template that we will have you fork -- or copy. This template can be found at [https://osf.io/rx5a3/](https://osf.io/rx5a3/)
...
Now that we've got some sense of what we'll be working with, let's go to the <a href="https://dmp-pgd.ca/">DMP Assistant</a> and start filling in the following sections/questions:
