...
The event will occur on **September 22-23 in Halifax, NS**. Venue information is still being confirmed, but will be updated once as soon as possible.

### Registration 

We know that budgets to attend events are becoming more limited, and to ensure representation from a diverse range of institutions and regions in Atlantic Canada, travel and accommodation will be covered for those that are accepted to the event. We are still working to the application process set-up, and communications will be sent out once things go live.

### Contact

If you have any questions about the event, please reach out to Sandra Sawchuk at: [sandra.sawchuk@msvu.ca](mailto:sandra.sawchuk@msvu.ca)
