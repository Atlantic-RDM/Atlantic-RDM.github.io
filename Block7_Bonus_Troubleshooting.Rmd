...
<h4 style="text-align:center;"><strong>Understanding and fixing errors is one of the most important (and sometimes frustrating!) parts of learning R.</strong></h4>
...
## Challenge 
Now, see if you can try your hand at some troubleshooting in the wild! We've created a RMarkdown file with some code related to the same Time Use dataset we've been using this week. You will notice a lot of errors when trying to run the code. 

See the [OSF repo](https://osf.io/38c74/) to access the files.
