...
## Block 2: Organizing and Documenting Data
...
* Revisit the files in the project and collaboratively develop an appropriate directory structure for the project
* Collaboratively develop a naming convention for the project
