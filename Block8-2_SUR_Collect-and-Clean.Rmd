...
Let's now remove the identifiers `name` and `email`.  To do this is a single command, we're going to use the `c()` function that was used in the [Introduction to R session](Block8-1_SUR_Intro-to-R.html)
