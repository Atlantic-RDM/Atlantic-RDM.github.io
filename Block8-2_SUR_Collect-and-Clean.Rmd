...
2) The `survey_data` object is then the data that we want to pass through the pipe `|>` to manipulate it.
...
IN addition to the `platforms` variable, you'll probably notice that 
