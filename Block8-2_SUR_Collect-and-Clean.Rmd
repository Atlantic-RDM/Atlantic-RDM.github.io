...
It is always recommended to document and describe your files and naming convention in a README file, which is described in details in the [Documentation ](Block2-3_Documentation.html) session. You can also refer to the [Naming Conventions and Folder structre](Block2-2_Naming-Conventions.html) session for inspiration in how you might go about renaming and structuring these files.
